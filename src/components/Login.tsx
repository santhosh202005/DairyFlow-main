...
import { Lock, User, LogIn, AlertCircle, Phone, Smartphone, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="p-8 bg-emerald-600 text-white text-center">
          ...
          <p className="text-emerald-100 text-sm mt-1">Sign in to your account</p>
        </div>

        <div className="flex border-b border-slate-100">
          <button
            onClick={() => { setLoginType('customer'); setError(''); setMessage(''); }}
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-6">
                  <div>
                    ...
                    <div className="mt-3 text-right">
                      <button 
                        type="button" 
                        onClick={() => { setIsOtpSent(false); setOtp(''); setMessage(''); setError(''); }}
